    ...
    <section className="py-16 bg-[#000c2a]">
      <div className="max-w-5xl mx-auto px-6">
        <div className="bg-white rounded-lg overflow-hidden shadow-xl flex flex-col md:flex-row">
          {/* Left side - Light image showcase */}
          <div className="w-full md:w-1/2 bg-[#f7faff] p-6 md:p-8 flex items-center justify-center">
            <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-4 shadow-lg">
              <div className="overflow-hidden rounded-xl bg-slate-50">
                <Image
                  ...
                  alt="SkillKwiz dashboard preview"
                  width={640}
                  height={480}
              ...
              <div className="mt-4 text-center">
                <h3 className="text-xl font-semibold text-[#00418d]">Build confidence with every assessment</h3>
                <p className="mt-2 text-sm text-slate-600">
                  Simple onboarding, clear insights, and a friendly experience for every learner.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 bg-[#00418d] p-8 flex items-center">
            <div className="w-full">
              ...
              <form className="space-y-4">
                ...
                <div className="pt-2 text-center text-sm text-white/90">
                  <span>Don&apos;t have an account? </span>
                  <a href="#" className="font-semibold text-[#f6c648] hover:underline">
                    Sign up
                  </a>
                </div>
              </form>
