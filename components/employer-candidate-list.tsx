...
export default function EmployerCandidateList() {
  ...
  const handleViewReport = (candidateName: string) => {
    if (candidateName !== "K. Pradeep Kishor") {
      return;
    }

    const link = document.createElement("a");
    link.href = "/downloads/skillkwiz-sample.txt";
    link.download = "skillkwiz-sample.txt";
