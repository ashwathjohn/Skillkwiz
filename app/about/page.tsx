...
export default function AboutPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative w-full bg-[#00418d] text-white relative overflow-hidden pt-20">
        <video
        ...
        <div className="max-w-7xl mx-auto px-6 py-10 relative z-10">
          ...
          <p className="text-center max-w-3xl mx-auto text-sm mb-6">
