              ...
              {userType === "employee" ? (
                <div className="bg-gradient-to-r from-[#3a4a7b]/90 to-[#9ba3b9]/90 rounded-lg p-8 backdrop-blur-sm">
                  {employeeRegistrationSuccess ? (
                    <SuccessMessage
                      title="Thank You!"
                      message="Your employee registration has been submitted successfully. We appreciate your interest and will help you proceed to the next step."
                ...
                <>
                  ...
                  {employerRegistrationSuccess ? (
                    <div className="bg-gradient-to-r from-[#3a4a7b]/90 to-[#9ba3b9]/90 rounded-lg p-8 backdrop-blur-sm">
                      <SuccessMessage
                        title="Thank You!"
                        message="Your employer registration has been submitted successfully. We appreciate your interest and will guide you to the next step."
